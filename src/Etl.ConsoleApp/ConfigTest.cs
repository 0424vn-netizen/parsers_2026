    ...
    public static class ConfigTest
    {
        public static Core.Etl CreateCD028()
        {
            return new Core.Etl
            {
                Extraction = {
                    ...
                    Comments = {
                        new Layout { Start=@"\A1CD-028", MaxStart=1, Children = new List<Layout>{
                            new Layout { Start=@"\A-MRCH", MaxStart=7, Children = new List<Layout>{
                    ...
                    Layout = new Layout
                    {
                        ...
                        Children = new List<Layout>{
                            ...
                            new Layout { Direction = LayoutDirection.Column, Children = new List<Layout>{
                            ...
                            new Layout { StartOffset = 2, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                new Layout { StartOffset = 59, EndOffset = 3, DataField = "CustomerCode" },
                            } },

                            new Layout { End=@"\A0END OF BATCH", EndOffset=1, Repeat=true, DataField="BATCHES", Children = new List<Layout>{
                                new Layout { Start = @"\A(-MRCH =)|(.{21}\d\d\/\d\d\/\d\d\s)", Children = new List<Layout>{
                                    new Layout { Start = @"\A(-MRCH =)|(.{21}\d\d\/\d\d\/\d\d\s)", End = @"\A-MRCH =", Repeat = true, DataField = "MERCHANTS", Children  = new List<Layout>{
                                        new Layout { Start=@"\A-MRCH =", MaxStart=1, Direction = LayoutDirection.Column, Children  = new List<Layout>{
                                            new Layout { StartOffset = 8, EndOffset = 16, DataField = "MerchantNumber" },
                                        } },
                                        new Layout { StartOffset = 1, Direction = LayoutDirection.Column, Children  = new List<Layout>{
                                            new Layout { Start = "TRUE DEPOSIT", StartOffset = 19, EndOffset = 2, DataField = "TrueDepositType" },
                                        } },

                                        new Layout { Start = @"\A.{21}\d\d\/\d\d\/\d\d\s", End = @"^.{21}\d\d\/\d\d\/\d\d\s", Repeat = true, DataField = "TRANSACTIONS", Children  = new List<Layout>{
                                            new Layout { Start = @"\A.{89}\d\d\/\d\d\/\d\d\s", EndOffset=1, MaxStart=1, Direction=LayoutDirection.Column, Children = new List<Layout>{
                                                new Layout { EndOffset=68, Direction=LayoutDirection.Column, Repeat= true, DataField="DOUBLE TRANSACTIONS", Children = new List<Layout>{
                                                    new Layout { EndOffset = 1, Direction = LayoutDirection.Column, Children  = new List<Layout>{
                                            ...
                                            new Layout { Start=@"PTS EDIT PEND.{0,4}$", EndOffset = 1, MaxStart=4, Direction = LayoutDirection.Column, Children  = new List<Layout>{
                                                new Layout { Start="PTS EDIT PENDED", EndOffset = 4, DataField = "Ignored" },
                                                } },

                                            new Layout { Start=@"\A..DBT\/DTL ADNDA", Children  = new List<Layout>{
                                                new Layout { EndOffset = 1, Direction = LayoutDirection.Column, Children  = new List<Layout>{
                                            ...
                                            new Layout { Start = @"\A..AUTH ADNDA", Children = new List<Layout>{
                                                new Layout { Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                ...
                                                new Layout { Start = @"\A..POS ADNDA:",  EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 12, DataField = "_PosAdndA" },
                                                } },
                                                new Layout { Start = @"\A..MKT SP1", EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 17, EndOffset = 1, DataField = "AVSResult" },
                                                    new Layout { StartOffset = 5, EndOffset = 12, DataField = "_Mktsp1AdndaE" },
                                                } },
                                                new Layout { Start = @"\A..MKT SP2", EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 17, EndOffset=41, DataField = "MarketData" },
                                                } },
                                                new Layout { Start = @"\A..CPS POS ADNDA:", EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                ...
                                                } },                                            new Layout { Start = @"\A..CHIP ADNDA 1", Children = new List<Layout>{
                                                new Layout { Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 15, DataField = "ChipAdndA1" },
                                                } },
                                                new Layout { Start = @"\A..CHIP ADNDA 2", EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 15, DataField = "ChipAdndA2" },
                                                } },
                                                new Layout { Start = @"\A..CHIP ADNDA 3", EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 15, DataField = "ChipAdndA3" },
                                                } },
                                                new Layout { Start = @"\A..CHIP ADNDA 4", EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 15, DataField = "ChipAdndA4" },
                                                } },
                                                new Layout { Start = @"\A..CHIP ADNDA 5",  EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                                                    new Layout { StartOffset = 15, DataField = "ChipAdndA5" },
                                                } },
                                                new Layout { Start = @"\A..CHIP ADNDA 6",  EndOffset = 1, Direction = LayoutDirection.Column, Children = new List<Layout>{
                    ...
                    Fields= {
                        new ArrayField {  DataField="BATCHES", Flat=true, Fields={
                            new ArrayField { DataField="MERCHANTS", Flat=true, Fields={
                                new ArrayField { DataField="TRANSACTIONS", Flat=true, IgnoreFields={ "_PosAdndA", "_Mktsp1AdndaE", }, Fields={
        ...
        public static Core.Etl CreateDelimiterDemoConfig()
        {
            return new Core.Etl
            {
                ...
                {
                    LayoutStartOffset = 3 ,
                    Layout = new Layout { Start=@"\A---main", End=@"\A---main", Repeat=true, Children = new List<Layout>{
                        new Layout  {StartOffset=1, Direction=LayoutDirection.Column, Children = new List<Layout>{
                            new Layout{ End=@"\|", DataField="F1"},
                            new Layout{ StartOffset=1, End=@"\|", DataField="F2"},
                            new Layout{ StartOffset=1, End=@"\|", DataField="F3"},
                        } },
                        new Layout { Start="---children", Children = new List<Layout>{
                            new Layout  {StartOffset=1, Direction=LayoutDirection.Column, Repeat = true, DataField="Children",  Children = new List<Layout>{
